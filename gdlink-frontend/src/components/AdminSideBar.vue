...
import SideBarTab from './SideBarTab.vue';
  ...
  export default {
    ...
    data() {
      const navItems = [
          { name: 'All Resources', link: '/admin/AllResources', icon: 'coursefiles' },
          { name: 'My ShareLinks', link: '/admin/my_sharelinks', icon: 'mysharelinks' },
          { name: 'User Log', link: '/admin/UserLog', icon: 'sharewithme' }
      ]
